(function () {
  ...
  qrButton.innerHTML = '<img src="../pocket/images/qrcode.png" alt="QR code for the PAULTJRCO Digital Business Card">';
  ...
  qrDialog.innerHTML = `
    ...
    <img src="../pocket/images/qrcode.png" alt="QR code for the PAULTJRCO Digital Business Card">
  `;
  ...
  if ("serviceWorker" in navigator && location.protocol.startsWith("http")) {
    window.addEventListener("load", () => navigator.serviceWorker.register("../pocket/sw.js").catch(() => {}));
  }
})();
